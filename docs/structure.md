...
- `src/state/`
  ...
  - `request.rs`
    - Request draft model.
    - Request name, folder path, method, URL, headers, optional body.
  - `response.rs`
...
- `src/ui/`
  ...
  - `request_panel.rs`
    - Request editor for name, folder path, method, URL, environment variables, headers, and body.
  - `response_panel.rs`
...
- Request ergonomics like auth/query tooling.
- Import/export.
- Final MVP polish.
